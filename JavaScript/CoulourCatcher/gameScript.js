/*
	...
	Notes:
		...
		Anything that gets logged in the console is just debug stuff
...
function endGame(status) {
	...
	var endscore = (Math.round(time/20) + (switches*4));
	var message1 = "You " + status;
	if (status != "Lose!") {
		var message2 =  "Score: " + endscore;
	}
	else{
		var message2 =  "Score: ---";
	}
	...
	document.getElementById("tweet").setAttribute("data-text=Check out Colour Catcher! I scored " + endscore + ", can you?");
